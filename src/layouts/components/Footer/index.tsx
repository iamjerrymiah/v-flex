        ...
        <Container>
            ...
            >
                <MotionAnimator delay={0.2}>
                    <SimpleGrid maxW={'100%'} columns={[1,1,1,3]} spacing={8} >
                        <div>
                            <Link to={'/'}>
                                <Image
                                    src={vEditionLogo}
                        ...
                        <div>
                            ...
                            <Stack color={'#000'} fontSize={'14px'} spacing={2}>
                                <li><Link to="/products/vl" className="hover:text-white">Men's Collection</Link></li>
                                <li><Link to="/products/vl" className="hover:text-white">Women's Collection</Link></li>
                                <li><Link to="/products/vl" className="hover:text-white">Store Collection</Link></li>
